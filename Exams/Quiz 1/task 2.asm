...
;take 9 integer numbers from user using an array. then find the sum of five integer numbers   with promt msg
	...
	mov ah, 2
	add bh, 48   ; as this is not a user given input now, so adjusting ascii by add bh, 48
